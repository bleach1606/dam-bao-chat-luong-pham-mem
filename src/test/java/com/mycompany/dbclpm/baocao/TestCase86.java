...
public class TestCase86 {
    ...
    public void TestCaseGetById1() {
        assertTrue(new Company(1, "Samsung", "CT01", stringToDate("2019-01-01"), 1, 3).equals(companyDAO.getById(1)) );
    }
    
    @Test
    public void TestCaseGetById2() {
        assertTrue(new Company(2, "Blameo", "CT02", stringToDate("2019-06-01"), 1, 3).equals(companyDAO.getById(2)) );
    }
    
    @Test
    public void listCompanyByDate() {
        ArrayList<Company> list = new ArrayList<>();
        list.add(new Company(1, "Samsung", "CT01", stringToDate("2019-01-01"), 1, 3));
        list.add(new Company(2, "Blameo", "CT02", stringToDate("2019-06-01"), 1, 3));
        assertTrue(compareCompany(list, companyDAO.getListByDate(stringToDate("2019-01-01"), stringToDate("2019-12-31"))));
    }
